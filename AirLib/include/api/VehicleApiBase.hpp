...
public:
    ...
    virtual Vector3r simGetTerrainHeight(double x, double y) const = 0;
    virtual void simSetObjectVelocity(const std::string& object_name, const Vector3r& velocity) = 0;
